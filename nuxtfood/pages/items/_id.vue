  ...
  <main class="container">
    ...
    <section class="details">
      ...
      <div class="quantity">
        ...
        <button class="primary" @click="add2Cart">
      ...
      <div class="toast" v-if="cartSubmitted">
        Order submitted<br />
...
export default {
  ...
  components: {
    AppToast: () => import("@/components/AppToast.vue"),
  },
  methods: {
    add2Cart() {
      let formOutput = {
      ...
      this.$store.commit("add2Cart", formOutput);
    },
  },
  computed: {
    ...mapState(["fooddata"]),
    ...
    //   for (owner of this.fooddata) {
    //     for (item in owner) {
    //       if (owner[item].id == this.id) {
    //         result = owner[item];
    //         break;
    //       }
    //     }
